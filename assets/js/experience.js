...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/condenast.jpg",
    place: "Conde Nast",
  ...
  },
  {
    ...
    place: "Delhi Technical University",
    time: "(Dec, 19 - Feb, 20)",
    desp: "<li>Worked on creating Design for DTU's Annual Fest, Engifest.</li><li>Designed inteface for a webpage that would help faculty to create a quiz using the questions from the database based on his/her choice of topics and he should be provided with various facilities and options to create a quiz of his choice.</li>",
  },
];
